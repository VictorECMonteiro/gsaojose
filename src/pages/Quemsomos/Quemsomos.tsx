...
export default function quemsomos() {
  ...
  return (
    <>
      <Helmet>
        <title>Quem Somos - Granja Sao Jose</title>
        <meta name='description' content='Quem somos - Nossa Historia, Trajetória e Legado Para Trazer O Melhor Para a Sua Mesa' />
      </Helmet>
      <NavBar />
